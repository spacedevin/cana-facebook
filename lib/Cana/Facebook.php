 ...
 */
class Cana_Facebook extends Cana_Model
{
	/**
 	* Version.
 	*/
 	...
 	* @throws Cana_Facebook_ApiException
 	*/
	protected function _restserver($params) {
		...
		if (is_array($result) && isset($result['error_code'])) {
			throw new Cana_Facebook_ApiException($result);
		}
		return $result;
	}
	...
	protected function _graph($path, $method='GET', $params=array()) {
		...
		if (is_array($result) && isset($result['error'])) {
			$e = new Cana_Facebook_ApiException($result);
	...
	protected function makeRequest($url, $params, $ch=null) {
		...
		$result = curl_exec($ch);
		if ($result === false) {
			$e = new Cana_Facebook_ApiException(array(
